...
void generate_data(struct Options options) {
  ...
  for (int i = 0; i < options.rows; i++) {
    ...
    char char_values[options.char_count];
...
int main(int argc, char *argv[]) {
  ...
  options.u64_count = 1;
  options.f64_count = 1;
  options.string_count = 1;
  options.char_count = 1;
